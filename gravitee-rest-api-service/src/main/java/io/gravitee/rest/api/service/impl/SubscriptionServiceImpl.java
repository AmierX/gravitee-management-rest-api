    ...
    public SubscriptionEntity create(NewSubscriptionEntity newSubscriptionEntity) {
        ...
        try {
            ...
            if (planEntity.getGeneralConditions() != null && !planEntity.getGeneralConditions().isEmpty()) {
                // keep the page id containing the general conditions
                // this may be useful to display general conditions in multi language
                // whereas the getGeneralConditionsContent contains the content validated by the subscriber
                subscription.setGeneralConditionsRef(planEntity.getGeneralConditions());
            }
